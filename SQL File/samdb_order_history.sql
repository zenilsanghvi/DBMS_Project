...
CREATE TABLE `order_history` (
  `oh_orderid` int DEFAULT NULL,
  `oh_prodid` varchar(45) DEFAULT NULL,
  `oh_qty` int DEFAULT NULL,
  KEY `oh_orderid_idx` (`oh_orderid`)
...
INSERT INTO `order_history` VALUES (10,'p2',1),(10,'p1',1);
