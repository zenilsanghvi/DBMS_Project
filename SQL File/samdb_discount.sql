...
CREATE TABLE `discount` (
  ...
  `d_discount_per` decimal(10,0) DEFAULT NULL,
  `d_active` tinyint DEFAULT NULL,
  PRIMARY KEY (`d_id`)
...
INSERT INTO `discount` VALUES ('disc0','No discount',0,1),('disc1','Winter ',40,1),('disc2','Black Friday',30,0),('disc3','Diwali',25,1),('disc4','Normal',10,1);
